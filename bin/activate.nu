...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/test/PycharmProjects/my_first_flask.app/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/test/PycharmProjects/my_first_flask.app/venv/bin/deactivate.nu'
